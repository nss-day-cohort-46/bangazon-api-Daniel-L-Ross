...
LEFT JOIN bangazonapi_customer c ON c.id = b_o.customer_id
LEFT JOIN auth_user a ON a.id = c.user_id
LEFT JOIN bangazonapi_payment pay ON pay.id = b_o.payment_type_id 
